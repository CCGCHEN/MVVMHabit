...
public class WebUtilsConfig implements Parcelable {
    ...
    public WebUtilsConfig setCacheMode(int cacheMode) {
    ...
    public WebUtilsConfig setUseWideViewPort(boolean useWideViewPort) {
    ...
    public WebUtilsConfig setLoadWithOverviewMode(boolean loadWithOverviewMode) {
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeInt(this.cacheMode);
        dest.writeByte(this.showTitleView ? (byte) 1 : (byte) 0);
        dest.writeByte(this.useWideViewPort ? (byte) 1 : (byte) 0);
        dest.writeByte(this.loadWithOverviewMode ? (byte) 1 : (byte) 0);
    ...
    protected WebUtilsConfig(Parcel in) {
        ...
        this.useWideViewPort = in.readByte() != 0;
        this.loadWithOverviewMode = in.readByte() != 0;
